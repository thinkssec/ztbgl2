...
LineTool.prototype = {
    ...
    showProperty: function (b) {
        ...
        //alert("showProperty  b==" + b + ",e==" + e + ",h==" + h);
...
var ControlTool = com.xjwgraph.ControlTool = function(b) {
    ...
    var d = function(f, e) {
        f.onkeydown = function(g) {
            ...
            else if (g.ctrlKey && g.keyCode == 65) {
            	//Ctrl+A 全选
            	keyDownFactory.selectTxt(f,g);
            }
        };
        if (e) {
            return
        ...
        if (lineSize > 0) {
            ...
            for (var j = baseLineKeyLength; j--; ) {
                ...
                if (u.xBaseMode == undefined || u.xBaseMode == "" ||
                    ...
                    //alert(u.xBaseMode + "," + u.wBaseMode + "," + u.xBaseMode.id + "-" + u.prop.XH);
                    return false;
                }
                //add by qw 2013.2.27 增加对每节点连接线XH的唯一性判断
                else {
                    //alert(u.xBaseMode.id + "-" + u.prop.XH);
                    if (lineArray[u.xBaseMode.id + "-" + u.prop.XH] == undefined) {
                        lineArray[u.xBaseMode.id + "-" + u.prop.XH] = u.xBaseMode.id + "-" + u.prop.XH;
                    }
                    else {
                        return false;
                    }
