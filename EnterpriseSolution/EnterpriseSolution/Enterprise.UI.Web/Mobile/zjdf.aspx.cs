...
{
    public partial class zjdf : Enterprise.Service.Basis.BasePage
    {
        ...
        public ProjectFwsModel fws = new ProjectFwsModel();
        ...
        private void BindGrid()
        {
            ...
            string sql = string.Format(@"select sys_guid()||'' pfid,t.crminfo,t.submitter, t.submittime, t.fnames, t.fviewnames, t.status,t.pf,a.*
                              ...
                              left join (select *
                                          ...
                                          where crminfo = '{0}'
                                            ...
                                            and submitter = {2}) t
                                on a.bzid = t.bzid
                             where a.projid = '{1}'  order by a.xmmc,a.xh", CrmInfo, ProjectId, this.userModel.USERID);
        ...
        protected void Btn_SAVE_Click(object sender, EventArgs e)
        {
            ...
            {
                fsrv.CreateZjpf(bzid, df, ProjectId, this.userModel.USERID, CrmInfo);
            }
            //if (zj !=null) {
            //    if (zj.STATUS > -1)
            //    {
            ...
            //    }
            //}
            Response.Redirect("zjdf.aspx?ProjectId=" + ProjectId + "&CrmInfo=" + CrmInfo);
        ...
        protected void Btn_PRE_Click(object sender, EventArgs e)
        {
            ...
            Response.Redirect("zjdf.aspx?ProjectId=" + ProjectId + "&CrmInfo=" + pre.CRMINFO);
        }
        ...
        protected void Btn_NEXT_Click(object sender, EventArgs e)
        {
            ...
            Response.Redirect("zjdf.aspx?ProjectId=" + ProjectId + "&CrmInfo=" + next.CRMINFO);
        }
    }
}