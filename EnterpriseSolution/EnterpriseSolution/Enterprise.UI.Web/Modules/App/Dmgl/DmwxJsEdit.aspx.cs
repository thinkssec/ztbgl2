...
{
    public partial class DmwxJsEdit : Enterprise.Service.Basis.BasePage
    {
        ...
        {
            //添加操作按钮
            CreateBT.AddButton("back.gif", Trans("返回"), "DmwxJsList.aspx", Utility.PopedomType.List, HeadMenu1);
        }
        ...
        private void OnBindData()
        {
            ...
            if (q != null)
            {
                ...
                Txt_JSJE.Text = q.JSJE.ToRequestString();
                Txt_JSRQ.Text = q.JSRQ.ToDateYMDFormat();
                ...
                Label1.InnerHtml = "<table>"+ToAttachHtml2(q.FVIEWNAMES) + ToAttachHtml2(q.FVIEWNAMES2) + ToAttachHtml2(q.FVIEWNAMES3)+"</table>";
            }
        }
        ...
        protected void BtnOk_OnClick(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                entity.JSJE = Txt_JSJE.Text.ToDecimal();
                entity.JSRQ = Txt_JSRQ.Text.ToDateTime();
                entity.JSR = this.userModel.USERID;
            ...
            Utility.ShowMsg(this.Page, "OK", this.Trans(_note), "DmwxJsEdit.aspx?Cmd=Edit&PID=" + pId);
        }
        ...
        protected void BtnAudit_OnClick(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (entity.STATUS > 4)
                {
                    Utility.ShowMsg(this.Page, "OK", this.Trans("已经完成结算！不需重复操作！"), "DmwxJsList.aspx");
                    return;
                }
                //entity.CREATETIME = DateTime.Now;
                //entity.SUBMITTER = Utility.Get_UserId;
            ...
            Utility.ShowMsg(this.Page, "OK", this.Trans(_note), "DmwxJsList.aspx");
        }
    }
}