<%@ Page Title="" Language="C#" MasterPageFile="~/Modules/App/Project/Project.Master" AutoEventWireup="true"
    CodeBehind="DmwxWgysEdit.aspx.cs" Inherits="Enterprise.UI.Web.Modules.App.Dmgl.DmwxWgysEdit"
    ...
    <div data-options="region:'center'">
        <div id="contents" class="ssec-form">
           ...
           <ul>
                ...
                <li>
                    <div>
                        <asp:TextBox ID="Txt_GCBH" runat="server" CssClass="easyui-validatebox" Width="150" required="true"   ></asp:TextBox>
                    </div>
             ...
             <ul>
                ...
                <li>
                    <div>
                        <asp:TextBox ID="Txt_GCDD" runat="server" CssClass="easyui-validatebox" Width="150" required="true" ></asp:TextBox>
                    </div>
            ...
            <ul>
                ...
                <li>
                    <div>
                        <asp:TextBox ID="Txt_GCNR" runat="server" CssClass="easyui-validatebox" Width="450" required="true" MaxLength="100" Height="50" TextMode="MultiLine" ></asp:TextBox>
                    </div>
            ...
            <ul>
                ...
                <li>
                    <div>
                        <asp:TextBox ID="Txt_GCBZ" runat="server" CssClass="easyui-validatebox" Width="450" MaxLength="100" Height="50" TextMode="MultiLine" ></asp:TextBox>
                    </div>
