<%@ Page Title="" Language="C#" MasterPageFile="~/Modules/App/Project/Project.Master" AutoEventWireup="true" 
    CodeBehind="DmwxWgysList.aspx.cs" Inherits="Enterprise.UI.Web.Modules.App.Dmgl.DmwxWgysList" %>
     ...
     <div class="main-gridview">
         <div class="main-gridview-title">
            ...
            <%=Trans("状态")%>：<asp:DropDownList ID="s_Type" runat="server">
                ...
                <asp:ListItem Text="未验收" Value="0"></asp:ListItem>
                <asp:ListItem Text="已验收" Value="1"></asp:ListItem>
            </asp:DropDownList>
