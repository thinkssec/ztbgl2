<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="HseSectAudit.aspx.cs" Inherits="Enterprise.UI.Web.Modules.App.Hse.HseSectAudit"
    ...
    <div data-options="region:'center'">
        <div id="contents" class="ssec-form">
            ...
            <ul>
                ...
                <li>
                    <div>
                        <asp:TextBox ID="Txt_SH1CONTENT" runat="server" Width="300" Height="60" TextMode="MultiLine"></asp:TextBox>
                    </div>
                </li>
            </ul>
