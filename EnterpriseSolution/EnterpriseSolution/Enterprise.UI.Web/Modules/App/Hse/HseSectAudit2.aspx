<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="HseSectAudit2.aspx.cs" Inherits="Enterprise.UI.Web.Modules.App.Hse.HseSectAudit2"
    ...
    <div data-options="region:'center'">
        <div id="contents" class="ssec-form">
            ...
            <ul>
                ...
                <li>
                    <div>
                        <asp:TextBox ID="Txt_SH2CONTENT" runat="server" Width="300" Height="60" TextMode="MultiLine" ></asp:TextBox>
                    </div>
                </li>
            </ul>
            <ul>
                ...
                <li>
                    <div>
                        <uc1:UserSelectControl runat="server" ID="User_SHR3" />
                    </div>
                </li>
            </ul>
            <ul>
