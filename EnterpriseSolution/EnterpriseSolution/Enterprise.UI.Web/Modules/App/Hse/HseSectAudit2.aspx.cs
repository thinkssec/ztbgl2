...
{
    public partial class HseSectAudit2 : Enterprise.Service.Basis.BasePage
    {
        ...
        protected void BtnSave_OnClick(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                entity.SH2CONTENT = Txt_SH2CONTENT.Text;
            ...
            Response.Redirect("HseSectAudit2.aspx?Cmd=Audit2&CKID=" + Hid_CKID.Value, false);
        }
        ...
        protected void BtnAuditPass_OnClick(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                entity.STATUS = 3;
                entity.SH2TIME = DateTime.Now;
                entity.SH2CONTENT = Txt_SH2CONTENT.Text;
                entity.SHR3 = User_SHR3.UserSelectValue.ToInt();
                entity.SH3SUBMITIME = DateTime.Now;
                entity.SH3STATUS = 0;
                entity.SH2STATUS = 1;
                //entity.CTARGET = Txt_TARGET.Text;
                //entity.CLEVEL = Ddl_LEVEL.SelectedValue;
