...
{
    public partial class HseSectAudit3 : Enterprise.Service.Basis.BasePage
    {
        ...
        private void OnBindData()
        {
            ...
            if (q != null)
            {
                ...
                Txt_SH2CONTENT.Text = q.SH2CONTENT;
                Txt_SH3CONTENT.Text = q.SH3CONTENT;
                User_SHR1.UserSelectValue = q.SHR1.ToRequestString();
                User_SHR2.UserSelectValue = q.SHR2.ToRequestString();
                User_SHR3.UserSelectValue = q.SHR3.ToRequestString();
        ...
        private string sendMessageToAudit(HseSectcheckModel model)
        {
            ...
            bfCtrl.SendNotificationMessage(
                model.CKID,//和项目关联的消息
                model.SHR3.Value,//接收人
                this.userModel,//当前用户
                string.Format("{0}-安全隐患整改审核，需要您进行查收!", model.CLEVEL),//消息标题
                string.Format("/Modules/App/Hse/HseSectAudit3.aspx?Cmd=Audit3&CKID={0}", model.CKID),//消息内容
        ...
        protected void BtnSave_OnClick(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                //entity.SHR3 = User_SHR3.UserSelectValue.ToInt();
                entity.SH3CONTENT = Txt_SH3CONTENT.Text;
            ...
            Response.Redirect("HseSectAudit3.aspx?Cmd=Audit3&CKID=" + Hid_CKID.Value, false);
        }
