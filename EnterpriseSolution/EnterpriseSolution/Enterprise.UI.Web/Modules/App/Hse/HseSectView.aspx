<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="HseSectView.aspx.cs" Inherits="Enterprise.UI.Web.Modules.App.Hse.HseSectView"
    ...
    <div data-options="region:'center'">
        <div id="contents" class="ssec-form">
            ...
            <ul>
                ...
                <li>
                    <div>
                        <asp:TextBox ID="Txt_SH3CONTENT" runat="server" Width="300" Height="60" TextMode="MultiLine" Enabled="false"></asp:TextBox>
                    </div>
                </li>
            </ul>
            <ul>
