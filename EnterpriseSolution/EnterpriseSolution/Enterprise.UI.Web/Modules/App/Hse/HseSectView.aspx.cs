...
{
    public partial class HseSectView : Enterprise.Service.Basis.BasePage
    {
        ...
        private string sendMessageToAudit(HseSectcheckModel model)
        {
            ...
            bfCtrl.SendNotificationMessage(
                ...
                string.Format("/Modules/App/Hse/HseSectView.aspx?Cmd=Audit3&CKID={0}", model.CKID),//消息内容
        ...
        protected void BtnSave_OnClick(object sender, EventArgs e)
        {
            ...
            Response.Redirect("HseSectView.aspx?Cmd=Audit3&CKID=" + Hid_CKID.Value, false);
        }
