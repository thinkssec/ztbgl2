...
namespace Enterprise.UI.Web.Modules.App.Project
{
    ...
    /// 项目列表页面
    /// </summary>
    public partial class ProjectInfoList2 : BasePage
    {
        #region 初始化参数区
        ...
        protected string GetCommandBtn(string id)
        {
            ...
            {
                if(m.RTN==666666)
                    btnStrs += string.Format("<a  href='ProjectRegister6.aspx?Cmd=Edit&PROJID={0}'><img alt=\"\" src=\"/Resources/Common/img/icon/application_edit.png\" border=\"0\" /></a>", id);
                else
                    btnStrs += string.Format("<a  href='ProjectRegister5.aspx?Cmd=Edit&PROJID={0}'><img alt=\"\" src=\"/Resources/Common/img/icon/application_edit.png\" border=\"0\" /></a>", id);
                btnStrs += "&nbsp;&nbsp;|&nbsp;&nbsp;";
                btnStrs += string.Format("<a  onclick='return confirm(\"您确定要删除该记录吗?\");' href='ProjectRegister5.aspx?Cmd=Delete&PROJID={0}'><img alt=\"\" src=\"/Resources/Styles/icon/delete.gif\" border=\"0\" /></a>", id);
            }
            else {
