<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="ProjectRegister4.aspx.cs" Inherits="Enterprise.UI.Web.Modules.App.Project.ProjectRegister4"
    ...
    <div data-options="region:'center'">
        <div id="contents" class="ssec-form">
            ...
            <ul>
                ...
                <li>
                    <div>
                        招标：<asp:RadioButtonList ID="Rad_ZBFS" runat="server" RepeatDirection="Horizontal">
                ...
                <li>
                    <div>
                        谈判：<asp:RadioButtonList ID="Rad_TP" runat="server" RepeatDirection="Horizontal">
            ...
            <ul>
                ...
                <li>
                    <div>
                        <asp:TextBox ID="Txt_PROJINCOME" runat="server" ClientIDMode="Static" CssClass="easyui-numberbox" min="0"
