...
namespace Enterprise.UI.Web.Modules.App.Project
{
    ...
    public partial class ProjectTeam : BasePage
    {
        ...
        protected string GetCommandBtn(string id)
        {
            ...
            //else
            {
                //btnStrs += string.Format("<a  href='ProjectRegister2.aspx?Cmd=Edit&PROJID={0}'><img alt=\"\" src=\"/Resources/Common/img/icon/application_edit.png\" border=\"0\" /></a>", id);
                //btnStrs += "&nbsp;&nbsp;|&nbsp;&nbsp;";
                //btnStrs += string.Format("<a  onclick='return confirm(\"您确定要删除该记录吗?\");' href='ProjectRegister2.aspx?Cmd=Delete&PROJID={0}'><img alt=\"\" src=\"/Resources/Styles/icon/delete.gif\" border=\"0\" /></a>", id);
                btnStrs += string.Format("<a  href='TeamMain.aspx?Cmd=Edit&ProjectId={0}'><img alt=\"\" src=\"/Resources/Styles/images/index_ldxx.png\" border=\"0\" /></a>", id);
            }
            return btnStrs;
        }
