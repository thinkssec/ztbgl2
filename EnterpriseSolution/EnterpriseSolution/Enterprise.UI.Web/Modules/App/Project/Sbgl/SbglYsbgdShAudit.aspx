<%@ Page Title="" Language="C#" MasterPageFile="~/Modules/App/Project/Project.Master" AutoEventWireup="true" 
    CodeBehind="SbglYsbgdShAudit.aspx.cs" Inherits="Enterprise.UI.Web.Modules.App.Project.Sbgl.SbglYsbgdShAudit" 
    ...
    <script type="text/javascript">
        function OnReady(id)  //Treelist抛给页面的事件
        {
            if (id == "AF") {
                ...
                //调用Load函数填充数据
                document.AF.func("Load", "/Modules/App/Project/Sbgl/SbglDataHandler.ashx?type=SBWXYSSH&PH=<%=Ysph%>");
                //在第一列位置插入新列 
