<%@ Page Title="" Language="C#" MasterPageFile="~/Modules/App/Project/Project.Master"
    AutoEventWireup="true" CodeBehind="ZbglKbhqdb.aspx.cs"
    Inherits="Enterprise.UI.Web.Modules.App.Project.ZbglKbhqdb" ValidateRequest="false" EnableEventValidation="false"  %>
        ...
        <div id="Div1" class="ssec-form">
            <table>
                <tr>
                    ...
                    <td   width="100px">&nbsp;&nbsp;&nbsp;&nbsp;
                        <a href='' class="easyui-linkbutton" id="H_Down" runat="server">下载</a>
                    </td>
                    <td   width="100px">
...
<p class=MsoTitle><a name="_Toc402171557"><span style='font-size:22.0pt;
font-family:宋体'>开标会签到表</span></a></p>

<p class=MsoNoSpacing><span style='font-family:宋体'>招标项目名称：</span><span
lang=EN-US style='font-family:宋体'><asp:Label ID="Lb_PNAME" runat="server"></asp:Label></span></p>

<p class=MsoNormal style='line-height:150%'><span style='line-height:150%;
font-family:宋体'>招标文件编号：<span lang=EN-US><asp:Label ID="Lb_PNUMBER" runat="server"></asp:Label></span></span></p>

<p class=MsoNormal style='line-height:150%'><span style='line-height:150%;
font-family:宋体'>开标地点：<span lang=EN-US><asp:Label ID="Lb_P001" runat="server"></asp:Label></span></span></p>

<p class=MsoNormal style='line-height:150%'><span style='line-height:150%;
font-family:宋体'>截标时间：</span><span lang=EN-US style='line-height:150%;
font-family:宋体'><asp:Label ID="Lb_P002" runat="server"></asp:Label></span></p>
...
<table class=MsoNormalTable border=1 cellspacing=0 cellpadding=0 width=568
 ...
 <tr style='height:1.0cm'>
  <td width=62 style='width:46.65pt;border:solid windowtext 1.0pt;padding:0cm 5.4pt 0cm 5.4pt;
  height:1.0cm'>
  ...
  none;padding:0cm 5.4pt 0cm 5.4pt;height:1.0cm'>
  <p class=MsoNormal align=center style='text-align:center'><span
  style='font-family:宋体'>法人或授权代表</span></p>
  </td>
  <td width=92 style='width:68.95pt;border:solid windowtext 1.0pt;border-left:
  none;padding:0cm 5.4pt 0cm 5.4pt;height:1.0cm'>
  <p class=MsoNormal align=center style='text-align:center'><span
  style='font-family:宋体'>职务<span lang=EN-US>/</span>职称</span></p>
  </td>
  ...
  style='font-family:宋体'>联系电话</span></p>
    ...
    <%
        ...
        foreach (var m in fwsL) {
         ...
         %>
 <tr style='height:1.0cm'>
  <td width=62 style='width:46.65pt;border:solid windowtext 1.0pt;border-top:
  none;padding:0cm 5.4pt 0cm 5.4pt;height:1.0cm'>
