...
namespace Enterprise.UI.Web.Modules.App.Project
{
    ...
    /// 项目成果交付页面
    /// </summary>
    public partial class ZbglKbpbgzjl : BasePage
    {
        ...
        /// 成果交付--服务类
        /// </summary>
        public ProjectKbpbgzjlService Service = new ProjectKbpbgzjlService();
        ...
        private void BindCommand()
        {
            ...
            //{
            //    CreateBT.AddButton("new.gif", "新增", "ZbglKbpbgzjl.aspx?Cmd=New&ProjectId=" + projectId + "&NodeCode=" + nodeCode, Utility.PopedomType.List, HeadMenu1);
        ...
        private void BindGrid()
        {
            ...
            ProjectKbpbgzjlModel tM = Service.GetList().Where(w => w.PROJID == projectId).FirstOrDefault();
            ...
            if (tM != null)
            {
                ...
                if (m != null)
                    Txt_param_001.Text = SysUserService.GetUserName(m.PERSONID.ToInt());
        ...
        {
            ProjectKbpbgzjlModel Model = Service.GetList().Where(p => p.PROJID == projectId).FirstOrDefault();
        ...
        protected string GetCommandBtn(string id)
        {
            ...
            btnStrs += string.Format("<a href='ZbglKbpbgzjl.aspx?Cmd=Edit&ProjectId={0}&Id={1}&NodeCode={2}'><img alt=\"\" src=\"/Resources/Styles/icon/application_edit.png\" border=\"0\"/></a>", projectId, id, nodeCode);
            btnStrs += "&nbsp;&nbsp;|&nbsp;&nbsp;";
            btnStrs += string.Format("<a onclick='return confirm(\"您确定要删除该记录吗?\");' href='ZbglKbpbgzjl.aspx?Cmd=Delete&ProjectId={0}&Id={1}&NodeCode={2}'><img alt=\"\" src=\"/Resources/Common/img/icon/delete.gif\" border=\"0\" /></a>", projectId, id, nodeCode);
            return btnStrs;
        }
        ...
        protected void BtnSave_Click(object sender, EventArgs e)
        {
            ...
            if (Model == null)
            {
                Model = new ProjectKbpbgzjlModel();
            ...
            ZbwjService.CreateKbpbgzjl(projectId);
            Utility.ShowMsgThenReloadTree(this.Page, "系统提示", ((isOk) ? "操作成功!" : "操作失败!!!"), "ZbglKbpbgzjl.aspx?ProjectId=" + projectId + "&NodeCode=" + nodeCode);
