...
namespace Enterprise.UI.Web.Modules.App.Project
{
    ...
    /// 项目成果交付页面
    /// </summary>
    public partial class ZbglPbbg : BasePage
    {
        ...
        /// 成果交付--服务类
        /// </summary>
        public ProjectPbbgService Service = new ProjectPbbgService();
        public ProjectInfoService infSrv = new ProjectInfoService();
        public ProjectPbbgService psSrv = new ProjectPbbgService();
        public List<ProjectFwsModel> fwsL = new List<ProjectFwsModel>();
        public ProjectPbbgModel tM = new ProjectPbbgModel();
        ...
        private void BindCommand()
        {
            ...
            //{
            //    CreateBT.AddButton("new.gif", "新增", "ZbglPbbg.aspx?Cmd=New&ProjectId=" + projectId + "&NodeCode=" + nodeCode, Utility.PopedomType.List, HeadMenu1);
        ...
        private void BindGrid()
        {
            ...
            tM = psSrv.GetList().FirstOrDefault(w=>w.PROJID==projectId);
            ...
            if (inM != null)
            {
                Lb_P003.Text = inM.NKBDD;
                Lb_P004.Text = inM.NKBSJ.ToRequestString();

            }
            if (zr != null) {
                Lb_P001.Text = SysUserService.GetUserName( zr.PERSONID.ToInt());
            }
            if (wyL != null) {
                string s="";
            ...
            if (pfL != null && pfL.Count > 0)
                Lb_P008.Text = CrmInfoService.GetCrmName( pfL.First().CRMINFO);
        }
        ...
        {
            ProjectPbbgModel Model = Service.GetList().Where(p => p.PROJID == projectId).FirstOrDefault();
            //ProjectInfoModel inM = infSrv.GetList().Where(w => w.PROJID == projectId).FirstOrDefault();
            Model.P1 = Txt_P005.Text;
            Model.P2 = Txt_P006.Text;
            Model.P3 = Txt_P007.Text;
            Model.P4 = Txt_P009.Text;
        ...
        protected string GetCommandBtn(string id)
        {
            ...
            btnStrs += string.Format("<a href='ZbglPbbg.aspx?Cmd=Edit&ProjectId={0}&Id={1}'><img alt=\"\" src=\"/Resources/Styles/icon/application_edit.png\" border=\"0\"/></a>", projectId, id);
            btnStrs += "&nbsp;&nbsp;|&nbsp;&nbsp;";
            btnStrs += string.Format("<a onclick='return confirm(\"您确定要删除该记录吗?\");' href='ZbglPbbg.aspx?Cmd=Delete&ProjectId={0}&Id={1}'><img alt=\"\" src=\"/Resources/Common/img/icon/delete.gif\" border=\"0\" /></a>", projectId, id);
            return btnStrs;
        }
        ...
        protected void BtnSave_Click(object sender, EventArgs e)
        {
            ...
            ZbwjService.CreatePbbg(projectId);
            Utility.ShowMsgThenReloadTree(this.Page, "系统提示", ((isOk) ? "操作成功!" : "操作失败!!!"), "ZbglPbbg.aspx?ProjectId=" + projectId );
