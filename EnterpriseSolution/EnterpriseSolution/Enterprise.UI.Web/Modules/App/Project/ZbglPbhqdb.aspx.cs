...
namespace Enterprise.UI.Web.Modules.App.Project
{
    ...
    /// 项目成果交付页面
    /// </summary>
    public partial class ZbglPbhqdb : BasePage
    {
        ...
        /// 成果交付--服务类
        /// </summary>
        public ProjectPbhqdbService Service = new ProjectPbhqdbService();
        ...
        private void BindCommand()
        {
            ...
            //{
            //    CreateBT.AddButton("new.gif", "新增", "ZbglPbhqdb.aspx?Cmd=New&ProjectId=" + projectId + "&NodeCode=" + nodeCode, Utility.PopedomType.List, HeadMenu1);
        ...
        private void BindGrid()
        {
            ...
            ProjectPbhqdbModel tM = Service.GetList().Where(w => w.PROJID == projectId).FirstOrDefault();
            ...
            string sql = @"select b.uname personname,decode(a.lb,1,'技术评委',2,'经济评委',3,'需求评委',5,'工作人员',6,'监督人员','') projid,a.* from APP_PROJECT_PSZJ a,basis_sys_user b where a.personid=b.userid and projid='" + projectId + "' and a.lb<>5 order by a.role desc ";
        ...
        {
            ProjectPbhqdbModel Model = Service.GetList().Where(p => p.PROJID == projectId).FirstOrDefault();
        ...
        protected string GetCommandBtn(string id)
        {
            ...
            btnStrs += string.Format("<a href='ZbglPbhqdb.aspx?Cmd=Edit&ProjectId={0}&Id={1}&NodeCode={2}'><img alt=\"\" src=\"/Resources/Styles/icon/application_edit.png\" border=\"0\"/></a>", projectId, id, nodeCode);
            btnStrs += "&nbsp;&nbsp;|&nbsp;&nbsp;";
            btnStrs += string.Format("<a onclick='return confirm(\"您确定要删除该记录吗?\");' href='ZbglPbhqdb.aspx?Cmd=Delete&ProjectId={0}&Id={1}&NodeCode={2}'><img alt=\"\" src=\"/Resources/Common/img/icon/delete.gif\" border=\"0\" /></a>", projectId, id, nodeCode);
            return btnStrs;
        }
        ...
        protected void BtnSave_Click(object sender, EventArgs e)
        {
            ...
            ZbwjService.CreatePbhqdb(projectId);
            Utility.ShowMsgThenReloadTree(this.Page, "系统提示", ((isOk) ? "操作成功!" : "操作失败!!!"), "ZbglPbhqdb.aspx?ProjectId=" + projectId + "&NodeCode=" + nodeCode);
