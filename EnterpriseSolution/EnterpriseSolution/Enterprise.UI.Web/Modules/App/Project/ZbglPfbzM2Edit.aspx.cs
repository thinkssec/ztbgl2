...
namespace Enterprise.UI.Web.Modules.App.Project
{
    ...
    /// 项目成果交付页面
    /// </summary>
    public partial class ZbglPfbzM2Edit : BasePage
    {
        ...
        {
            CreateBT.AddButton("orderby.gif", "引用", "ZbglPfbzList.aspx?Cmd=Get&MID=" + mId+"&ProjectId="+ProjectId, Utility.PopedomType.List, HeadMenu1);
            if (SysUserPermissionService.CheckPageCode(this.userModel.USERID, 1, "0602", (int)Utility.PopedomType.New))
            {
                CreateBT.AddButton("new.gif", "新增", "ZbglPfbzM2Edit.aspx?Cmd=New&MID=" + mId+"&ProjectId="+ProjectId, Utility.PopedomType.List, HeadMenu1);
                GridView1.Columns[GridView1.Columns.Count - 1].Visible = true;
            }
            else {
                GridView1.Columns[GridView1.Columns.Count - 1].Visible = false;
            }
            CreateBT.AddButton("back.gif", "返回", "ZbglPfbzM2List.aspx?ProjectId="+ProjectId, Utility.PopedomType.List, HeadMenu1);
        }
        ...
        protected string GetCommandBtn(string id)
        {
            ...
            btnStrs += string.Format("<a href='ZbglPfbzM2Edit.aspx?Cmd=Edit&MID={0}&Id={1}&ProjectId={2}'><img alt=\"\" src=\"/Resources/Styles/icon/application_edit.png\" border=\"0\"/></a>", Hid_MID.Value, id,ProjectId);
            btnStrs += "&nbsp;&nbsp;|&nbsp;&nbsp;";
            btnStrs += string.Format("<a onclick='return confirm(\"您确定要删除该记录吗?\");' href='ZbglPfbzM2Edit.aspx?Cmd=Delete&MID={0}&Id={1}&ProjectId={2}'><img alt=\"\" src=\"/Resources/Common/img/icon/delete.gif\" border=\"0\" /></a>", Hid_MID.Value, id,ProjectId);
            return btnStrs;
        }
        ...
        protected void BtnSave_Click(object sender, EventArgs e)
        {
            ...
            Utility.ShowMsgThenReloadTree(this.Page, "系统提示", ((isOk) ? "操作成功!" : "操作失败!!!"), "ZbglPfbzM2Edit.aspx?MID=" + Hid_MID.Value+"&ProjectId="+ProjectId);
