<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master"
    AutoEventWireup="true" CodeBehind="ZbglPfbzMList.aspx.cs"
    Inherits="Enterprise.UI.Web.Modules.App.Project.ZbglPfbzMList"  ValidateRequest="false" %>
            ...
            <asp:GridView ID="GridView1" runat="server" DataKeyNames="MID"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="模板名称">
                        <ItemTemplate>
                            <a href="ZbglPfbzMEdit.aspx?MID=<%#(string)Eval("MID")%>"><%#(string)Eval("MNAME")%></a>
                        </ItemTemplate>
                    </asp:TemplateField>
