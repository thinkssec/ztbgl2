...
namespace Enterprise.UI.Web.Modules.App.Project
{
    ...
    /// 项目成果交付页面
    /// </summary>
    public partial class ZbglPfbzMList : BasePage
    {
        ...
        private void BindCommand()
        {
            ...
            if (SysUserPermissionService.CheckButtonPermission(Utility.PopedomType.New)||this.userModel.UADMIN==1)
            {
                CreateBT.AddButton("new.gif", "新增", "ZbglPfbzMList.aspx?Cmd=New", Utility.PopedomType.List, HeadMenu1);
        ...
        protected string GetCommandBtn(string id)
        {
            ...
            btnStrs += string.Format("<a href='ZbglPfbzMList.aspx?Cmd=Edit&Id={0}'><img alt=\"\" src=\"/Resources/Styles/icon/application_edit.png\" border=\"0\"/></a>", id);
            btnStrs += "&nbsp;&nbsp;|&nbsp;&nbsp;";
            btnStrs += string.Format("<a onclick='return confirm(\"您确定要删除该记录吗?\");' href='ZbglPfbzMList.aspx?Cmd=Delete&Id={0}'><img alt=\"\" src=\"/Resources/Common/img/icon/delete.gif\" border=\"0\" /></a>",id);
            return btnStrs;
        }
        ...
        protected void BtnSave_Click(object sender, EventArgs e)
        {
            ...
            Utility.ShowMsgThenReloadTree(this.Page, "系统提示", ((isOk) ? "操作成功!" : "操作失败!!!"), "ZbglPfbzMList.aspx");
