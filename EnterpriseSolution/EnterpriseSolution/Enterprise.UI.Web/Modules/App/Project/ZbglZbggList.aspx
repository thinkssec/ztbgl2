<%@ Page Title="" Language="C#" MasterPageFile="~/Modules/App/Project/Project.Master"
    AutoEventWireup="true" CodeBehind="ZbglZbggList.aspx.cs"
    Inherits="Enterprise.UI.Web.Modules.App.Project.ZbglZbggList"  ValidateRequest="false" %>
        ...
        <div class="main-gridview">
            <asp:GridView ID="GridView1" runat="server" DataKeyNames="BZID"
                ...
                <Columns>
                    ...
                    <asp:BoundField HeaderText="评分标准" DataField="PFBZ"></asp:BoundField>
