...
namespace Enterprise.UI.Web.Modules.App.Project
{
    ...
    /// 项目成果交付页面
    /// </summary>
    public partial class ZbglZbjgspb : BasePage
    {
        ...
        /// 成果交付--服务类
        /// </summary>
        public ProjectZbjgspbService Service = new ProjectZbjgspbService();
        public ProjectInfoService infSrv = new ProjectInfoService();
        public List<ProjectFwsModel> fwsL = new List<ProjectFwsModel>();
        public ProjectZbjgspbModel tM = new ProjectZbjgspbModel();
        ...
        private void BindCommand()
        {
            ...
            //{
            //    CreateBT.AddButton("new.gif", "新增", "ZbglZbjgspb.aspx?Cmd=New&ProjectId=" + projectId + "&NodeCode=" + nodeCode, Utility.PopedomType.List, HeadMenu1);
        ...
        {
            ProjectZbjgspbModel Model = Service.GetList().Where(p => p.PROJID == projectId).FirstOrDefault();
        ...
        protected string GetCommandBtn(string id)
        {
            ...
            btnStrs += string.Format("<a href='ZbglZbjgspb.aspx?Cmd=Edit&ProjectId={0}&Id={1}'><img alt=\"\" src=\"/Resources/Styles/icon/application_edit.png\" border=\"0\"/></a>", projectId, id);
            btnStrs += "&nbsp;&nbsp;|&nbsp;&nbsp;";
            btnStrs += string.Format("<a onclick='return confirm(\"您确定要删除该记录吗?\");' href='ZbglZbjgspb.aspx?Cmd=Delete&ProjectId={0}&Id={1}'><img alt=\"\" src=\"/Resources/Common/img/icon/delete.gif\" border=\"0\" /></a>", projectId, id);
            return btnStrs;
        }
        ...
        protected void BtnSave_Click(object sender, EventArgs e)
        {
            ...
            ZbwjService.CreateZbjgspb(projectId);
            Utility.ShowMsgThenReloadTree(this.Page, "系统提示", ((isOk) ? "操作成功!" : "操作失败!!!"), "ZbglZbjgspb.aspx?ProjectId=" + projectId );
