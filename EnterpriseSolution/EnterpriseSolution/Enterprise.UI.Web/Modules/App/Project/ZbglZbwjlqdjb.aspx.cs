...
namespace Enterprise.UI.Web.Modules.App.Project
{
    ...
    /// 项目成果交付页面
    /// </summary>
    public partial class ZbglZbwjlqdjb : BasePage
    {
        ...
        /// 成果交付--服务类
        /// </summary>
        public ProjectZbwjlqdjbService Service = new ProjectZbwjlqdjbService();
        ...
        private void BindCommand()
        {
            ...
            //{
            //    CreateBT.AddButton("new.gif", "新增", "ZbglZbwjlqdjb.aspx?Cmd=New&ProjectId=" + projectId + "&NodeCode=" + nodeCode, Utility.PopedomType.List, HeadMenu1);
        ...
        private void BindGrid()
        {
            ...
            ProjectZbwjlqdjbModel tM = Service.GetList().Where(w => w.PROJID == projectId).FirstOrDefault();
        ...
        {
            ProjectZbwjlqdjbModel Model = Service.GetList().Where(p => p.PROJID == projectId).FirstOrDefault();
        ...
        protected string GetCommandBtn(string id)
        {
            ...
            btnStrs += string.Format("<a href='ZbglZbwjlqdjb.aspx?Cmd=Edit&ProjectId={0}&Id={1}&NodeCode={2}'><img alt=\"\" src=\"/Resources/Styles/icon/application_edit.png\" border=\"0\"/></a>", projectId, id, nodeCode);
            btnStrs += "&nbsp;&nbsp;|&nbsp;&nbsp;";
            btnStrs += string.Format("<a onclick='return confirm(\"您确定要删除该记录吗?\");' href='ZbglZbwjlqdjb.aspx?Cmd=Delete&ProjectId={0}&Id={1}&NodeCode={2}'><img alt=\"\" src=\"/Resources/Common/img/icon/delete.gif\" border=\"0\" /></a>", projectId, id, nodeCode);
            return btnStrs;
        }
        ...
        protected void BtnSave_Click(object sender, EventArgs e)
        {
            ...
            if (Model == null)
            {
                Model = new ProjectZbwjlqdjbModel();
            ...
            ZbwjService.CreateZbwjlqdjb(projectId);
            Utility.ShowMsgThenReloadTree(this.Page, "系统提示", ((isOk) ? "操作成功!" : "操作失败!!!"), "ZbglZbwjlqdjb.aspx?ProjectId=" + projectId + "&NodeCode=" + nodeCode);
