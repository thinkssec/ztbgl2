...
{
    public partial class ZyglDjEdit : Enterprise.Service.Basis.BasePage
    {
        ...
        {
            //添加操作按钮
            CreateBT.AddButton("back.gif", Trans("返回"), "ZyglDjList.aspx", Utility.PopedomType.List, HeadMenu1);
        }
        ...
        protected void BtnSave_OnClick(object sender, EventArgs e)
        {
            ...
            Utility.ShowMsg(this.Page, "OK", this.Trans(_note), "ZyglDjList.aspx");
        }
