...
{
    public partial class ZyglGxEdit : Enterprise.Service.Basis.BasePage
    {
        ...
        {
            //添加操作按钮
            CreateBT.AddButton("back.gif", Trans("返回"), "ZyglGxList.aspx", Utility.PopedomType.List, HeadMenu1);
        }
        ...
        private void OnBindData()
        {
            ...
            if (q != null)
            {
                ...
                string sql = "select jh,kgrq,to_char(lrsj,'yyyy-mm-dd') rq,gxjs,(select dmmc from  vw_fla16_1 where dm=gxdm) gxmc,sgxh from VW_DDH011 where jh='" + q.JH + "' and to_char(kgrq,'yyyy-mm-dd')='" + q.STARTDATE.ToDateYMDFormat() + "' order by lrsj,sgxh";
                DataSet ds = null;
