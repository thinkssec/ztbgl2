...
{
    public partial class ZyglJdList : Enterprise.Service.Basis.BasePage
    {
        ...
        protected string GetCommandBtn(string id)
        {
            ...
            if (m.STATUS == 3)
            {
                btnStrs += string.Format("<a  href='ZyglJdEdit.aspx?Cmd=Edit&ZID={0}'><img alt=\"\" src=\"/Resources/Common/img/icon/application_edit.png\" border=\"0\" /></a>", id);
