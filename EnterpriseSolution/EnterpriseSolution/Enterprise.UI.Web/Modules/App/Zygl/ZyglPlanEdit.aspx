<%@ Page Title="" Language="C#" MasterPageFile="~/Modules/App/Project/Project.Master" AutoEventWireup="true"
    CodeBehind="ZyglPlanEdit.aspx.cs" Inherits="Enterprise.UI.Web.Modules.App.Zygl.ZyglPlanEdit"
    ...
    <div data-options="region:'center'">
        <div id="contents" class="ssec-form">
            ...
            <ul>
                ...
                <li>
                    <div>
                        <asp:TextBox ID="Txt_JH" runat="server" CssClass="easyui-validatebox" required="true"></asp:TextBox>
                    </div>
                </li>
            </ul>
            ...
            <ul>
                ...
                <li>
                    <div>
                        <asp:TextBox ID="Txt_DYQK" runat="server" CssClass="easyui-validatebox" required="true"></asp:TextBox>
                    </div>
                </li>
            </ul>
            ...
            <ul>
                ...
                <li>
                    <div>
                        <asp:TextBox ID="Txt_CW" runat="server" CssClass="easyui-validatebox" required="true"></asp:TextBox>
                    </div>
                </li>
            </ul>
            ...
            <ul>
                ...
                <li>
                    <div>
                        <asp:TextBox ID="Txt_LASTDATE" runat="server" CssClass="easyui-datebox"></asp:TextBox>
                    </div>
                </li>
            </ul>
            <ul>
                ...
                <li>
                    <div>
                        <asp:TextBox ID="Txt_LSGNR" runat="server" CssClass="easyui-validatebox" ></asp:TextBox>
                    </div>
                </li>
            </ul>
            <ul>
                ...
                <li>
                    <div>
                        <asp:TextBox ID="Txt_SCZQ" runat="server" CssClass="easyui-numberbox" Width="150" min="0" percision="2"></asp:TextBox>
                    </div>
                </li>
            </ul>
            ...
            <ul>
                ...
                <li>
                    <div>
                        <asp:TextBox ID="Txt_ZYYY" runat="server" CssClass="easyui-validatebox" Width="450" required="true" MaxLength="100" Height="50" TextMode="MultiLine"></asp:TextBox>
                    </div>
                </li>
            </ul>
            ...
            <ul>
                ...
                <li>
                    <div>
                        <asp:TextBox ID="Txt_SGNR" runat="server" CssClass="easyui-validatebox" required="true"></asp:TextBox>
                    </div>
                </li>
            </ul>
            ...
            <ul>
                ...
                <li>
                    <div>
                        <asp:DropDownList ID="Ddl_ZYFL" runat="server">
            ...
            <ul>
                ...
                <li>
                    <div>
                        <asp:TextBox ID="Txt_CSLB" runat="server" CssClass="easyui-validatebox" required="true"></asp:TextBox>
                    </div>
                </li>
            </ul>
            ...
            <ul>
                ...
                <li>
                    <div>
                        <asp:TextBox ID="Txt_YSE" runat="server" CssClass="easyui-numberbox" Width="150" required="true" min="0" percision="4"></asp:TextBox>
                    </div>
