...
{
    public partial class ZyglPlanList : Enterprise.Service.Basis.BasePage
    {
        ...
        protected string GetCommandBtn(string id)
        {
            ...
            if (m.STATUS < 0)
            {
                btnStrs += string.Format("<a  href='ZyglPlanEdit.aspx?Cmd=Edit&ZID={0}'><img alt=\"\" src=\"/Resources/Common/img/icon/application_edit.png\" border=\"0\" /></a>", id);
                btnStrs += "&nbsp;&nbsp;|&nbsp;&nbsp;";
                btnStrs += string.Format("<a  onclick='return confirm(\"您确定要删除该记录吗?\");' href='ZyglPlanEdit.aspx?Cmd=Delete&ZID={0}'><img alt=\"\" src=\"/Resources/Styles/icon/delete.gif\" border=\"0\" /></a>", id);
            }
            return btnStrs;
        }
    }
