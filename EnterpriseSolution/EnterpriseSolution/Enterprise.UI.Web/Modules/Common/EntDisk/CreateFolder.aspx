<%@ Page Title="" Language="C#" MasterPageFile="~/Modules/Common/EntDisk/MainPage.Master" AutoEventWireup="true"
    CodeBehind="CreateFolder.aspx.cs" Inherits="Enterprise.UI.Web.Modules.EntDisk.CreateFolder" %>
...
<div id="dvMsgbox" style="display: block;" class="gSys-msg">
                ...
                <div class="gSys-body edit">
                    <table class="g-table-optcomm">
                        <tbody>
                            ...
                            <tr>
                                <th>
                                    <%=Enterprise.Service.Basis.Sys.SysDictionaryService.TransTo("文件夹名")%>：
                                </th>
                                <td>
                                    <asp:TextBox ID="fName" runat="server" CssClass="ipt-t"></asp:TextBox>
                                </td>
                            </tr>                            
                        </tbody>
                    </table>
        ...
        <div class="ft bdr-c-dark bg-cont" style="margin-left: 100px;">
            <div class="opt">
                <asp:ImageButton ID="Ok" runat="server" ImageUrl="Content/Img/ok.jpg" OnClick="Ok_OnClick" />
            </div>
        </div>
    </div>
</asp:Content>
