<%@ Page Title="" Language="C#" MasterPageFile="~/Modules/Common/EntDisk/MainPage.Master" AutoEventWireup="true" CodeBehind="DeleteFolder.aspx.cs" Inherits="Enterprise.UI.Web.Modules.EntDisk.DeleteFolder" %>
                    ...
                    <table class="g-table-optcomm">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <font color="red">
                                    <%=Enterprise.Service.Basis.Sys.SysDictionaryService.TransTo("请慎重操作")%>，
                                    <%=Enterprise.Service.Basis.Sys.SysDictionaryService.TransTo("删除文件夹将删除文件夹下所有文件及文件夹")%>！</font>
                                </td>
                            </tr>                                
                        </tbody>
                    </table>
