<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UserSelectControl.ascx.cs" Inherits="Enterprise.UI.Web.Component.UserControl.UserSelectControl" %>

<asp:TextBox ID="tbDeptxt" runat="server" CssClass="easyui-combotree" Width="250"></asp:TextBox>
...
<script>  
    ...
    $('#<%=tbDeptxt.ClientID%>').combotree({
        ...
        onSelect:function(rec){            
            var url = '/Component/UserControl/Json/GetUser.ashx?deptid='+rec.id+'<%=Addition%>';
