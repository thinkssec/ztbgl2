<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="ProjectAudit.aspx.cs" Inherits="Enterprise.UI.Web.Modules.App.Project.ProjectAudit"
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainPH" runat="server">
    ...
    <div data-options="region:'center'">
        <div id="contents" class="ssec-form">
                                ...
                                <asp:TemplateField HeaderText="服务商" ItemStyle-HorizontalAlign="Left">
                                    <ItemTemplate>
                                        <asp:DropDownList ID="Ddl_WTDW" ClientIDMode="Static" runat="server" CssClass="easyui-combobox"
                                             Width="300px" data-options="panelWidth: 500,loader: myloader,mode: 'remote',valueField: 'id',textField: 'name',onSelect:sle,formatter: formatItem"></asp:DropDownList>
           ...
           <asp:Panel ID="Pnl_Audit_Show" runat="server" Visible="false">
                <uc1:ProjectAuditUControl runat="server" ID="UC_Shenhe_Show" />
            </asp:Panel>
            <ul>
                <li class="ssec-label">

                    <asp:Label ID="Lb_yj" runat="server"  Text="审核意见"></asp:Label> ：
