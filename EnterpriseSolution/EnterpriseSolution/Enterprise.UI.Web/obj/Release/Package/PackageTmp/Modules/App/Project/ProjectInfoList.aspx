<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" EnableEventValidation = "false" AutoEventWireup="true" 
    CodeBehind="ProjectInfoList.aspx.cs" Inherits="Enterprise.UI.Web.Modules.App.Project.ProjectInfoList" %>
        ...
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" Width="100%"
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="项目名称">
                    <ItemTemplate>
                        <a href="/Modules/App/Project/ProjectInfoView.aspx?Lb=1&Cmd=Edit&PROJID=<%#(string)Eval("PROJID") %>"><%#Eval("PROJNAME")%></a>
                    </ItemTemplate>
                </asp:TemplateField>
