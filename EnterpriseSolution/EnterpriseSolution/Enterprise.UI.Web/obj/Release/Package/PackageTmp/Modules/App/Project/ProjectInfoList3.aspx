<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" EnableEventValidation="false" AutoEventWireup="true"
    CodeBehind="ProjectInfoList3.aspx.cs" Inherits="Enterprise.UI.Web.Modules.App.Project.ProjectInfoList3" %>
            ...
            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" Width="100%"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="项目名称">
                        <ItemTemplate>
                            <a href="/Modules/App/Project/ProjectInfoViewTp.aspx?Lb=1&Cmd=Edit&PROJID=<%#(string)Eval("PROJID") %>"><%#Eval("PROJNAME")%></a>
                        </ItemTemplate>
                    </asp:TemplateField>
                ...
                <asp:TemplateField HeaderText="隐患接受人">
                    ...
                    <asp:TemplateField HeaderText="申请表" ItemStyle-HorizontalAlign="Center">
                        <ItemStyle Width="50" />
                        <ItemTemplate>
