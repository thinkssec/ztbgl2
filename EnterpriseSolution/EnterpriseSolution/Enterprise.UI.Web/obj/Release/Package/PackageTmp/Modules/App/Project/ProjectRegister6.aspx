<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="ProjectRegister6.aspx.cs" Inherits="Enterprise.UI.Web.Modules.App.Project.ProjectRegister6"
    ...
    <div data-options="region:'center'">
        <div id="contents" class="ssec-form">
            ...
            <ul>
                ...
                <li>
                    <div>
                        <uc1:UserSelectControl runat="server" ID="User_Submitter"/>
                    </div>
                </li>
            </ul>
            ...
            <ul>
                ...
                <li>
                    <asp:DropDownList ID="Ddl_YWBM" runat="server">
                        ...
                        <asp:ListItem Value="139">计划部</asp:ListItem>
                        ...
                        <asp:ListItem Value="144">储气库管理部</asp:ListItem>
                    </asp:DropDownList>
            ...
            <%--<ul>
                ...
                <li>
                    <div>
                        <uc1:UserSelectControl runat="server" ID="User_SPR5"/>
                    </div>
                </li>
            </ul>--%>
            <ul>
                ...
                <li>
                    <asp:DropDownList ID="User_SPR51" runat="server" Required="true" CssClass="easyui-combobox" Width="153" data-options="editable:false"></asp:DropDownList>
