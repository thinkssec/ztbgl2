<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SbglMain.aspx.cs"
    Inherits="Enterprise.UI.Web.Modules.App.Project.SbglMain" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript" lang="ja">
        var treedata = '/Component/UserControl/Json/NodesTreeHandler.ashx?Type=1';
        var index = 0;
...
<body class="easyui-layout">
    <div data-options="region:'north',border:false" style="height: 42px; padding: 5px;" class="projectdefaultbg">
        <div class="projectdefault-topleft">
            <span class="projectdefault-name">设备管理&nbsp;&nbsp;</span>
            <span class="projectdefault-manager">&nbsp;&nbsp;</span>
        </div>
        <div class="projectdefault-topright">
            <a href="/" class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-projectp1'">返回首页</a> 
