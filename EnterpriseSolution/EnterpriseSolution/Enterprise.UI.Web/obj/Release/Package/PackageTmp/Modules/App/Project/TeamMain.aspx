<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TeamMain.aspx.cs"
    Inherits="Enterprise.UI.Web.Modules.App.Project.TeamMain" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript" lang="ja">
        var treedata = '/Component/UserControl/Json/NodesTreeHandler.ashx?Type=6';
        var index = 0;
        ...
        $(function () {
            ...
            addTab('ProjectInfoView2.aspx', '招标申请明细');
        })
    </script>
</head>
<body class="easyui-layout">
    <div data-options="region:'north',border:false" style="height: 42px; padding: 5px;" class="projectdefaultbg">
        <div class="projectdefault-topleft">
            <span class="projectdefault-name">组建评标委员会 &nbsp;&nbsp;</span>
