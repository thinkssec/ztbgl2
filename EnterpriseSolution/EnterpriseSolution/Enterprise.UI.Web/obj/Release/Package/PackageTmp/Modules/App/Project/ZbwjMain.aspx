<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ZbwjMain.aspx.cs"
    Inherits="Enterprise.UI.Web.Modules.App.Project.ZbwjMain" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript" lang="ja">
        var treedata = '/Component/UserControl/Json/NodesTreeHandler.ashx?Type=4';
        var index = 0;
...
<body class="easyui-layout">
    <div data-options="region:'north',border:false" style="height: 42px; padding: 5px;" class="projectdefaultbg">
        <div class="projectdefault-topleft">
            <span class="projectdefault-name">招标文件编制&nbsp;&nbsp;</span>
