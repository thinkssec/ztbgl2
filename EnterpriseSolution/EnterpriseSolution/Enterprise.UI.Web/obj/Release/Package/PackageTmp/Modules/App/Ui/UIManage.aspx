<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="UIManage.aspx.cs" Inherits="Enterprise.UI.Web.Modules.App.Ui.UIManage" %>
    ...
    <div data-options="region:'center'">
            ...
            <asp:GridView ID="GridView1" runat="server" Width="100%">
                <Columns>
                    <asp:TemplateField HeaderText="角色">
                        <ItemTemplate>
                            <%#((Enterprise.Model.Basis.Sys.SysRoleModel)Eval("SysRole")).RNAME%>
                        </ItemTemplate>
                    </asp:TemplateField>
                    ...
                    <asp:TemplateField ShowHeader="False" ItemStyle-Width="150">
                        <ItemTemplate>
                            <%#GetCommandBtn((string)Eval("DefaultID"))%>
                        </ItemTemplate>
                    </asp:TemplateField>
                </Columns>
            </asp:GridView>
        ...
        <div id="Edit" runat="server" visible="false">
            <div id="contents" class="ssec-form">
                ...
                <%--表单构建开始--%>
                <ul>
                    <li class="ssec-label">角色：</li>
                    <li>
                        <asp:DropDownList ID="tb_role" runat="server"></asp:DropDownList></li>
                </ul>
                <ul>
