<%@ Page Title="" Language="C#" MasterPageFile="~/Modules/App/Project/Project.Master" AutoEventWireup="true"
    CodeBehind="ZyglJdEdit.aspx.cs" Inherits="Enterprise.UI.Web.Modules.App.Zygl.ZyglJdEdit"
                    ...
                    <div class="main-gridview">
                        <asp:GridView ID="GridView1" AutoGenerateColumns="False" Width="100%" runat="server"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="措施类别">
                                    <ItemStyle Width="80" />
                                    <ItemTemplate>
                                        <%# Eval("CSLB")%>
                                    </ItemTemplate>
                                ...
                                <asp:TemplateField HeaderText="施工内容">
