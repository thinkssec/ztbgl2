<%@ Page Title="" Language="C#" MasterPageFile="~/Modules/App/Project/Project.Master" AutoEventWireup="true"
    CodeBehind="ZyglJsEdit.aspx.cs" Inherits="Enterprise.UI.Web.Modules.App.Zygl.ZyglJsEdit"
    ...
    <div data-options="region:'center'">
        <div id="contents" class="ssec-form">
            ...
            <ul >
                ...
                <li >
                    <div>
                        <asp:TextBox ID="Txt_SGDW" runat="server"  Enabled="false"></asp:TextBox>
                    </div>
            ...
            <ul >
                ...
                <li >
                    <div>
                        <asp:TextBox ID="Txt_SGXCMS" runat="server" Width="400" Height="100" TextMode="MultiLine"  Enabled="false"></asp:TextBox>
                    </div>
