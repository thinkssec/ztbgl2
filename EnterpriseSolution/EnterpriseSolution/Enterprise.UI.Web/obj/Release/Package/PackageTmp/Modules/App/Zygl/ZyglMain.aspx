<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ZyglMain.aspx.cs"
    Inherits="Enterprise.UI.Web.Modules.App.Zygl.ZyglMain" %>
...
<body class="easyui-layout">
    <div data-options="region:'north',border:false" style="height: 42px; padding: 5px;" class="projectdefaultbg">
        <div class="projectdefault-topleft">
            <span class="projectdefault-name">作业运行管理&nbsp;&nbsp;</span>
