<%@ Page Title="" Language="C#" MasterPageFile="~/Modules/App/Project/Project.Master" AutoEventWireup="true" 
    CodeBehind="ZyglWgysList.aspx.cs" Inherits="Enterprise.UI.Web.Modules.App.Zygl.ZyglWgysList" %>
            ...
            <%--显示有效通知的信息--%>
             <%=Trans("作业类别")%>：<asp:DropDownList ID="s_Type2" runat="server">
                <asp:ListItem Text="全部" Value=""></asp:ListItem>
                 <asp:ListItem Text="完工" Value="完工"></asp:ListItem>
                <asp:ListItem Text="验收" Value="验收"></asp:ListItem>
            </asp:DropDownList>
