<%@ Page Title="" Language="C#" MasterPageFile="~/Modules/Common/EntDisk/MainPage.Master" AutoEventWireup="true" CodeBehind="DeleteSelect.aspx.cs" Inherits="Enterprise.UI.Web.Modules.EntDisk.DeleteSelect" %>
                    ...
                    <table class="g-table-optcomm">
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <asp:Label ID="filePath_Txt" runat="server"></asp:Label><asp:HiddenField ID="hfilePath" runat="server" />
                                </td>
                            </tr>    
                            <tr>
                                <th>
