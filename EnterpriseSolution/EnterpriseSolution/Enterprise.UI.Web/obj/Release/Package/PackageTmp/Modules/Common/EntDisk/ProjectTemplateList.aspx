<%@ Page Title="" Language="C#" MasterPageFile="~/Modules/App/Project/Project.Master" AutoEventWireup="true"
    CodeBehind="ProjectTemplateList.aspx.cs" Inherits="Enterprise.UI.Web.Modules.EntDisk.ProjectTemplateList" %>
                    ...
                    <table class="g-table-comm">
                        ...
                        <tbody class="back">
                            <tr>
                                ...
                                <td class="wd1 ckb"></td>
                                <td colspan="3">
                                    <a href="ProjectTemplateList.aspx?sid=<%=sid %>&typeId=<%=typeId %>&amp;desc=true&amp;fid=<%=BackFilePathName %>">
                        ...
                        <tbody id="listBody">
                            ...
                            <tr id="tr_<%=gId %>" style="background-color: rgb(255, 255, 255);" onmousemove="javascript:ShowDiv('<%=gId %>');"
                                ...
                                <td class="wd2">
                                    ...
                                    <%if (file.fileType == 0)
                                      { %>
                                    <a class="name" href="ProjectTemplateList.aspx?sid=<%=sid %>&typeId=<%=typeId %>&amp;desc=true&amp;fid=<%=FilePathName+Path.DirectorySeparatorChar+Path.GetFileName(file.fileName) %>">
